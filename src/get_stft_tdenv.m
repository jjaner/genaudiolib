function [magfft phasefft tdenv params] = get_stft_tdenv(audiofile, inParams)
% 
...
if ~exist(stftfilename) || (exist('inParams.zerophase') && inParams.zerophase ~= params.zerophase),
    ...
    [magfft phasefft tdenv] = compute_stft_tdenv(x(:,1)', window, params.hopsize, params.fftsize, params.zerophase);
